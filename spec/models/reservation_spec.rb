...
RSpec.describe Reservation, type: :model do
  before do
    @user = User.create(name: 'Franck', email: 'franck@g.com', password: '123456')
  ...
  it 'Should be invalid if returning date is less than reservation date' do
    @reservation = Reservation.new(reservation_date: '2020/01/01', returning_date: '2001/11/11', city: 'kampala',
                                   user: @user, aeroplane: @aeroplane)
